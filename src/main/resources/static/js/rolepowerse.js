		...
		function initmenutable(powerid){
			$('#powerlist').datagrid({    
			    url:'../user/querymenuList.do?powerid='+powerid, 
			    singleSelect:true,
			    checkOnSelect:false,
			    selectOnCheck:false,
			    pagination:true,
			    ...
			    toolbar:[{
			    	...
			    	handler:function(){
			    		$('#addDiv').dialog({
			    			title:'新增菜单',
			    			href:'../wwquser/seeAddMenu.do?id='+powerid,
			    			width:400,
			    			height:250,
			    			buttons:[{
				    				text:'保存',
		...
		function editmenu(id){
			...
			$('#addDiv').dialog({
    			title:'新增菜单',
    			href:'../wwquser/seeEditMenu.do?id='+id,
    			width:400,
    			height:250,
    			buttons:[{
	    				text:'保存',
		...
		function edit(){
			...
			$('#addDiv').dialog({
    			title:'修改节点',
    			href:"../user/toeditPower.do?id="+treeArr.id+"&text="+treeArr.text+"&url="+treeArr.url+"&pid="+treeArr.pid+"",
    			width:400,
    			height:200,
    			buttons:[{
	    				text:'保存',
